...
```shell
curl --location --request GET 'https://api.noahex-test.com/v1/spot/trade?symbol&orderSide&orderType&bizType=SPOT&orderId&fromId&direction&startTime=&endTime=&limit=20' \
