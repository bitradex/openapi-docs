...
|----------|-------|--------|----|----------------|
| orderIds | query | string | Yes  | 订单ID集合(最多100条) |

> Request Example

```shell
curl --location --request GET 'https://api.bitradex-test.com/v1/spot/batch-order?orderIds=401876438755871040,401653869310150976&abc=' \
