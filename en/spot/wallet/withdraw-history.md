...
```shell
curl --location --request GET 'https://api.noahex-test.com/v1/spot/withdraw/history?currency=usdt&chain=Tron&status&fromId&direction=NEXT&limit=10&startTime&endTime' \
